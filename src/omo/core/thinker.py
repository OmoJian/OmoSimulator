...
class Thinker:
    ...
    def require_thought(self, *thoughts, color=None, style=None):
        if color is None:
            ...
            self.thoughts += '\n' + colored(
                choice(thoughts), color, attrs=style)
        ...
        if urine_ratio < 0.2 and self._state.mode == StateMode.LESSON:
            if self._state.teacher.testing:
                ...
                self.require_thought(
                    self._state.current_lesson() + ' is so boring!',
            ...
            if self._state.mode == StateMode.LESSON:
                if self._state.teacher.testing:
                    ...
                    self.require_thought(
                        self._state.current_lesson() +
                        ' is so boring! Also I need to pee.',
                        "I've got to pee a bit, but... Not really much.",
    ...
    def think_about_embarrassment(self):
        self.require_thought(
            "Oh... I'm so embarrassed...", 'I feel embarrassed...',
            "Classmates know that I have to pee. That's very bad.")

    def think_about_thirst(self):
        self.require_thought("I'm thirsty.", "I'm so thirsty...",
